...
function setup()
 {
  ...
  ground=createSprite(600,570,1400,10);
...
function spawnObstacles() {
  if(frameCount % 70 === 0) {
    var obstacle = createSprite(1000,520,10,40);
    //obstacle.debug = true;
